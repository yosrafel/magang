              ...
              <tbody>
                <?php $__currentLoopData = $servis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td><?php echo e($servis->tgl_in); ?></td>
                    <td><?php echo e($servis->status); ?></td>
                    <td><a href="/servis/user/<?php echo e($servis->id); ?>/dtl_servis" class="badge badge-warning">Lihat Detail</a></td>
                  </tr>
...
<?php echo $__env->make('layout/servis_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Rafel\coding\els\resources\views/servis/user/index.blade.php ENDPATH**/ ?>