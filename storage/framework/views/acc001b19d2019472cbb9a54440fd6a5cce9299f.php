    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
          <!-- logo start -->
          <div class="logo"> <a href="/servis/user/index"><img src="/assets/images/logos/logo.png" alt="logo" /></a> </div>
          <!-- logo end -->
        </div>
        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                <li> <a class="<?php echo $__env->yieldContent('home'); ?>" href="/servis/index">Home</a></li>
                <li> <a class="<?php echo $__env->yieldContent('history'); ?>" href="/servis/user/history">History</a></li>
...
<footer class="footer_style_2">
      ...
      <div class="footer_blog">
        <div class="row">
          <div class="col-md-3">
            ...
            <p>Jalan C.Simanjuntak 38, Yogyakarta </br>
          ...
          <div class="col-md-3">
            <div class="main-heading left_text">
              <h2>Download Aplikasi Mobile Els Computer Di</h2>
            </div>
            <ul class="footer-menu">
              <li><a href="https://play.google.com/store/apps/details?id=com.els.computer" target="_blank"><img src="/assets/images/google.png" alt="google" width="200px" height="65px"></a></li></br>
              <li><a href="https://apps.apple.com/id/app/els-computer/id1449470007" target="_blank"><img src="/assets/images/appstore.png" alt="appstore" width="200px" height="65px"></a></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="cprt">
    <p>© Copyright 2020 - Els Computer | Design by <a href="https://html.design/" target="_blank">html.design</a></p>
  </div>
</footer>
<!-- end footer -->
...
<?php /**PATH D:\Rafel\coding\els\resources\views/layout/servis_user.blade.php ENDPATH**/ ?>